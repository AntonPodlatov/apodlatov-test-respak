...
insert into technics_models (tm_id,
                             ...
                             tm_size_id,
                             ttd_id)
values (1, true, 'Cyclone V11™ Absolute Extra', 22000, 'CLNCV11', 1, 1, 1),
       (2, true, 'V10 Motorhead', 18000, 'V10MOTOR', 2, 2, 1),
       (3, true, 'Mi Robot Vacuum-Mop P', 25000, 'MIVACUMP', 3, 2, 2),
       (4, true, 'Mi Vacuum Cleaner G10', 23000, 'MIVACG10', 1, 3, 2),
       (5, true, 'Serie 8 BGS7MS64', 20000, 'SERIE8BGSM', 2, 4, 3),
       (6, true, 'ProPower M2378', 19000, 'PROPWR2378', 3, 5, 3),

       (7, true, 'iPhone 13 Pro', 80000, 'IPHONE13P', 1, 5, 4),
       (8, true, 'iPhone 12', 70000, 'IPHONE12', 2, 5, 4),
       ...
       (13, true, 'MacBook Pro 16', 120000, 'MBPRO16', 1, 5, 7),
       (14, true, 'MacBook Air', 80000, 'MBAIR13', 2, 5, 7),
       (15, true, 'Galaxy Book', 100000, 'GALAXYBOOK', 3, 5, 8),
       (16, true, 'Notebook Odyssey', 90000, 'NBOOKODYS', 1, 5, 8),
       (17, true, 'Vaio Z', 90000, 'VAIOZ', 2, 5, 9),
       (18, true, 'Vaio SX14', 85000, 'VAIOSX14', 3, 5, 9),

       (19, true, 'GC-B459SQUM', 35000, 'GCB459SQUM1', 1, 5, 10),
       (20, true, 'GC-B509SBSM', 30000, 'GCB509SBSM2', 2, 5, 10),
       (21, true, 'TF050D', 32000, 'DEXPTF050D', 3, 5, 11),
       (22, true, 'DEXP S2-17AHE', 29000, 'DEXPS2-17AHE12', 1, 5, 11),
       (23, true, 'Hitachi R-WB800', 55000, 'HITACHIRWB', 2, 5, 12),
       (24, true, 'Hitachi JX330', 50000, 'HITACHIJX3', 3, 5, 12),

       (25, true, 'Samsung UHD', 40000, 'SAMSUNGUHD', 1, 5, 13),
       (26, true, 'Samsung QLED', 42000, 'SAMSUNGQLED', 2, 5, 13),
       (27, true, 'Sony Bravia', 45000, 'SONYBRAVIA', 3, 5, 14),
       (28, true, 'Sony X90J', 47000, 'SONYX90J', 1, 5, 14),
       (29, true, 'Mi TV 4S', 30000, 'MITV4S', 2, 5, 15),
